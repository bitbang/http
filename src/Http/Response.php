...
class Response extends Message
{
	 ...
	 * @param  ICoder $coder
	 */
	public function __construct($code, array $headers, $body, ICoder $coder = NULL)
	{
		$this->code = (int) $code;
	...
	{
		if ($this->previous) {
			throw new LogicException('Previous response is already set.');
		}
	...
	{
		return $this->getCoder()->decode($this);
	}
